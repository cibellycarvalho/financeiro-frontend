...
const modalBox = {
  background: 'white', borderRadius: 16, padding: 32, width: 400, maxWidth: '90vw',
  ...
  return (
    <div style={modalOverlay} onClick={onFechar}>
      <div style={modalBox} onClick={e => e.stopPropagation()}>
        ...
        {erro && <p style={{ color: '#c00', margin: 0 }}>{erro}</p>}
  ...
  return (
    <Layout>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 32 }}>
        {fornecedores.map(f => (
          <div key={f.id}
            style={{ position: 'relative', cursor: 'pointer', background: fornecedorSel?.id === f.id ? '#1a1a1a' : 'white',
